...
const frontendAccessibilityTeachingReplacements: Array<[string, string]> = [
  ["case-014-release-readiness", "frontend-accessibility-proof"],
  ["c14-", "a11y-"],
  ["上线前夜巡查", "无障碍交付庭巡查"],
  ["上线检查小抄", "语义、焦点与移动端小抄"],
  ["上线前夜结案报告", "无障碍交付结案报告"],
  ...
  ["灰度", "分设备复测"],
  ["暂缓", "补证"],
  ["上线清单：不是点部署，是逐项过门", "无障碍清单：不是截图好看，是逐项过门"],
  [
    "只看发布前必须确认的步骤、证据和责任人",
    "只看用户任务、语义结构、键盘路径和移动端证据",
  ],
  [
    "交付通过 → 无障碍交付清单 → 交付窗口",
    "用户任务 → 语义结构 → 键盘路径 → 390px 复测",
  ],
  [
    "交付通过 → 上线清单 → 发布窗口",
    "用户任务 → 语义结构 → 键盘路径 → 390px 复测",
  ],
  ["docs/release-checklist.md", "docs/accessibility-checklist.md"],
  ["releaseGateChecklist", "accessibilityChecklist"],
  ["已审查通过的交付", "待验收的前端交互"],
  ["可以无障碍交付 / 补证无障碍交付", "可交付 / 需要补无障碍证据"],
  ["可以上线 / 暂缓上线", "可交付 / 需要补无障碍证据"],
  ["口头承诺", "只说截图好看"],
  ["没有证据的已检查", "没有键盘或读屏证据的已检查"],
  ["临时补的模糊项", "只加 aria-label 的模糊修复"],
  [
    "计划：用户任务、受影响用户、键盘路径、验证路径。",
    "任务：按钮、表单、错误提示要完成什么。",
  ],
  [
    "计划：发布窗口、影响范围、负责人、验证路径。",
  ...
  [
    "配置：语义结构、aria-live 错误反馈、功能开关均已确认。",
    "语义：button、label、landmark 和状态文案可识别。",
  ],
  [
    "配置：生产 API URL、AI_API_KEY、功能开关均已确认。",
    "语义：button、label、landmark 和状态文案可识别。",
  ...
  [
    "数据：迁移前移动端复测完成，390px 复测步骤已演练或记录。",
    "键盘：Tab 顺序、焦点样式、Enter/Space 可用。",
  ],
  [
    "数据：迁移前备份完成，恢复步骤已演练或记录。",
    "键盘：Tab 顺序、焦点样式、Enter/Space 可用。",
  ...
  [
    "监控：错误率、接口耗时、关键业务指标已有人复测。",
    "反馈：错误和成功状态不只靠颜色，读屏能感知。",
  ],
  [
    "监控：错误率、接口耗时、关键业务指标已有人值守。",
    "反馈：错误和成功状态不只靠颜色，读屏能感知。",
  ...
  [
    "回归：触发条件、回归命令、回归后验证路径已写清。",
    "复测：390px、读屏、键盘和旧功能回归证据已写清。",
  ],
  [
    "回滚：触发条件、回滚命令、回滚后验证路径已写清。",
    "复测：390px、读屏、键盘和旧功能回归证据已写清。",
  ...
  [
    "无障碍交付清单要能决定是否放行。每一项都要有可观察证据，而不是写“已确认”。",
    "无障碍交付清单要能决定是否可交付。每一项都要有键盘、读屏、移动端或回归证据，而不是写“看起来没问题”。",
  ],
  [
    "上线清单要能决定是否放行。每一项都要有可观察证据，而不是写“已确认”。",
    "无障碍交付清单要能决定是否可交付。每一项都要有键盘、读屏、移动端或回归证据，而不是写“看起来没问题”。",
  ],
  ["配置与回滚：线上不是你的本地电脑", "语义与回归：漂亮不是可用"],
  [
    "只看环境变量、功能开关和回滚条件如何保护无障碍交付",
    "只看语义、焦点、状态提示和回归证据如何保护用户路径",
  ],
  [
  ...
  ["release/production-readiness.md", "frontend/accessibility-audit.md"],
  ["productionReadiness", "accessibilityReadiness"],
  ["用户使用配置和交付版本", "组件代码和用户路径"],
  ["生产配置和发布版本", "组件代码和用户路径"],
  ["稳定运行或安全回退", "键盘、读屏和移动端路径可完成"],
  ["真实状态提示值", "辅助技术细节噪声"],
  ["真实密钥值", "辅助技术细节噪声"],
  ["无关交付平台细节", "无关视觉装饰"],
  ["无关部署平台细节", "无关视觉装饰"],
  ["未授权线上操作", "不替用户执行真实发布"],
  [
    "requiredEnv: ['DATABASE_URL', 'aria-live 错误反馈', '焦点顺序']",
    "semantic: button + label + landmark",
  ],
  [
    "requiredEnv: ['DATABASE_URL', 'AI_API_KEY', 'APP_ORIGIN']",
    "semantic: button + label + landmark",
  ...
  [
    "featureFlag: aiCareerRpgRoute = 'gradual-rollout'",
    "keyboard: Tab -> focus visible -> Enter/Space",
  ],
  [
    "rollbackWhen: errorRate > 2% 或保存成功率明显下降",
    "feedback: loading/error/success must be text + aria-live",
  ],
  [
    "rollbackVerify: 旧版本恢复后，登录、保存、AI 调用主路径通过",
    "responsiveVerify: 390px 无横向溢出，旧路径仍通过",
  ],
  [
    "无障碍交付前要知道用户使用依赖什么配置、如何分设备复测、何时回归，以及回归后怎么证明系统恢复。",
    "无障碍交付前要知道组件结构是否可识别、键盘能否走完、状态是否可感知，以及 390px 和旧路径怎么复测。",
  ],
  [
    "上线前要知道线上依赖什么配置、如何灰度、何时回滚，以及回滚后怎么证明系统恢复。",
    "无障碍交付前要知道组件结构是否可识别、键盘能否走完、状态是否可感知，以及 390px 和旧路径怎么复测。",
  ...
  [
    "上线计划、环境变量、数据移动端复测、自动检查和回归",
    "用户任务、语义结构、键盘路径、状态反馈和 390px 复测",
  ],
  [
    "上线计划、环境变量、数据备份、监控和回滚",
    "用户任务、语义结构、键盘路径、状态反馈和 390px 复测",
  ],
  [
    "能说出无障碍交付检查清单，并解释失败后怎么发现、怎么回归",
    "能说出无障碍交付检查清单，并解释键盘、读屏、移动端和回归证据分别证明什么",
  ],
  [
  ...
  ["无障碍交付计划", "用户任务"],
  ["release checklist", "accessibility checklist"],
  ["env checklist", "a11y checklist"],
  ["交付窗口", "关键路径"],
  ["已通过审查的交付", "待验收的前端交互"],
  ["交付行动表", "验收路线"],
  ["配置与ARIA 状态", "语义与状态反馈"],
  [
    "确认用户使用环境需要的状态提示、URL、开关和权限都存在且安全。",
    "确认按钮、表单、错误提示和状态变化能被键盘与读屏理解。",
  ],
  ["用户使用环境配置", "组件语义和状态"],
  ["可运行配置", "可理解状态"],
  ["移动端复测不可恢复", "移动端路径不可用"],
  [
    "确认数据库迁移、移动端复测和恢复路径，保护用户数据。",
    "确认 390px 小屏、读屏提示和键盘路径都能完成同一个任务。",
  ],
  ["数据变更计划", "移动端布局"],
  ["迁移计划", "读屏提示记录"],
  [
    "无障碍交付后观察错误率、耗时、日志和关键业务指标。",
    "交付前后观察键盘路径、读屏提示、自动检查和关键任务完成率。",
  ],
  ["线上流量", "用户操作"],
  ["健康/异常信号", "可用/不可用信号"],
  [
    "预先写清触发条件、回归步骤和回归后验证。",
    "预先写清旧功能、移动端和键盘读屏路径怎么复测。",
  ],
  ["异常信号", "回归风险"],
  ["恢复到稳定版本", "回到可用路径"],
  ["回归影响数据", "回归影响旧路径"],
  ...
  [
    "计划：关键路径、受影响用户、键盘路径、验证路径。",
    "任务：按钮、表单、错误提示要完成什么。",
  ],
  [
    "数据：迁移前移动端复测完成，390px 与读屏路径已复测并记录。",
    "移动端：390px 无横向溢出，读屏路径已复测并记录。",
  ],
  [
    "自动检查：错误率、键盘路径记录、关键业务指标已有人复测。",
    "检查：自动扫描、键盘路径和关键任务完成率已记录。",
  ],
  ["配置与回归：线上不是你的本地电脑", "语义与回归：漂亮不等于可用"],
  [
    "只看ARIA 状态、功能开关和回归风险如何保护无障碍交付",
    "只看语义、焦点、状态提示和回归证据如何保护用户路径",
  ],
  ["可访问状态和交付版本", "组件代码和用户路径"],
  [
    "无障碍交付前要知道线上依赖什么配置、如何分设备复测、何时回归，以及回归后怎么证明系统恢复。",
    "无障碍交付前要知道组件结构是否可识别、键盘能否走完、状态是否可感知，以及 390px 和旧路径怎么复测。",
  ],
];
...
export const frontendAccessibilityProofScenario: TeachingScenario = {
  ...
  projectMap: rewriteTeachingCopy(
    case14Map,
    frontendAccessibilityTeachingReplacements,
  ),
  steps: rewriteTeachingCopy(
    case14Scenario.steps.map((step) => {
      const titles: Record<string, string> = {
        ...
        "c14-code-tour": "关键代码：漂亮页面怎样证明可用",
        "c14-evidence": "证据连接：截图好看不等于可交付",
        "c14-close": "无障碍交付结案报告",
      };
      return {
        ...step,
